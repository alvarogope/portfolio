   export const about = {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "The same drive, in another key",
        body:
          "I have always wanted to play in a band, and I do. Music is the clearest way I have to express what I am feeling, which is the same thing I am doing when I design a game, so I try to bring the two together and score the worlds I build. The instinct is identical: take something you feel and give it a form other people can step inside.",
      },
      {
        kicker: "Where I'm going",
        title: "To lead, one day, by understanding everything",
        body:
